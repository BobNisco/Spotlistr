 ...
 *
 * ```js
 * var listr = angular.module('listr', []);
 * listr.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://listr.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://listr.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('listr', []).config(function($sceDelegateProvider) {
 ...
 *        'http://listr.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="listrController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("listrController", function listrController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('listrWithSceDisabledlistr', []).config(function($sceProvider) {
